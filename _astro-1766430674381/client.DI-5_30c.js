...
import { s as w, d as y, e as R } from "./scrollToSection.CGzsTRI9.js";
import { av as $ } from "./siteModulesConstants.BJBunYQ-.js";
const E = /\s|&nbsp;/g,
  M = (t) => {
    try {
...
function I(t, e, n, s, i, c) {
  return _(), v("a", { href: t.to.path }, [A(t.$slots, "default")], 8, B);
}
...
const F =
  ...
  async (e, n, s, { client: i }) => {
    ...
    for (const [r, u] of Object.entries(s))
      a[r] = () => l(P, { value: u, name: r === "default" ? void 0 : r });
    const p = i !== "only",
      h = p ? y : R;
    let o = d.get(t);
    if (o) (o.props = n), (o.slots = a), o.component.$forceUpdate();
      ...
      const r = h({
        name: c,
        render() {
          let u = l(e, o.props, o.slots);
          return (o.component = this), Q(e.setup) && (u = l(S, null, u)), u;
        },
      });
